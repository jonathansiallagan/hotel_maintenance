<x-admin-layout>
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Laporan Maintenance</h2>
        ...
        <form action="{{ route('admin.reports.index') }}" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('admin.reports.print', ['start_date' => $startDate, 'end_date' => $endDate, 'status' => $status]) }}"
                    target="_blank" class="bg-gray-800 text-white px-5 py-2 rounded-lg font-bold text-sm hover:bg-gray-900 transition">
